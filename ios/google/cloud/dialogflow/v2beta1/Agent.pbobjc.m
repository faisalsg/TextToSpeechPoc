...
#import "google/cloud/dialogflow/v2beta1/Agent.pbobjc.h"
...
GPBObjCClassDeclaration(DFAgent);
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "agentsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(DFAgent),
...
void DFExportAgentResponse_ClearAgentOneOfCase(DFExportAgentResponse *message) {
  GPBDescriptor *descriptor = [DFExportAgentResponse descriptor];
...
void DFImportAgentRequest_ClearAgentOneOfCase(DFImportAgentRequest *message) {
  GPBDescriptor *descriptor = [DFImportAgentRequest descriptor];
  GPBOneofDescriptor *oneof = [descriptor.oneofs objectAtIndex:0];
  GPBClearOneof(message, oneof);
}
...
void DFRestoreAgentRequest_ClearAgentOneOfCase(DFRestoreAgentRequest *message) {
  GPBDescriptor *descriptor = [DFRestoreAgentRequest descriptor];
  GPBOneofDescriptor *oneof = [descriptor.oneofs objectAtIndex:0];
  GPBClearOneof(message, oneof);
}
