...
GPBObjCClassDeclaration(DFSynthesizeSpeechConfig);
GPBObjCClassDeclaration(DFVoiceSelectionParams);
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "voice",
        .dataTypeSpecific.clazz = GPBObjCClass(DFVoiceSelectionParams),
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFSynthesizeSpeechConfig),
