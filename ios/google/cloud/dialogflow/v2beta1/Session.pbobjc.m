...
#import "google/cloud/dialogflow/v2beta1/AudioConfig.pbobjc.h"
...
GPBObjCClassDeclaration(DFInputAudioConfig);
GPBObjCClassDeclaration(DFIntent);
GPBObjCClassDeclaration(DFIntent_Message);
GPBObjCClassDeclaration(DFKnowledgeAnswers);
GPBObjCClassDeclaration(DFKnowledgeAnswers_Answer);
GPBObjCClassDeclaration(DFOutputAudioConfig);
GPBObjCClassDeclaration(DFQueryInput);
GPBObjCClassDeclaration(DFQueryParameters);
GPBObjCClassDeclaration(DFQueryResult);
GPBObjCClassDeclaration(DFSentiment);
GPBObjCClassDeclaration(DFSentimentAnalysisRequestConfig);
GPBObjCClassDeclaration(DFSentimentAnalysisResult);
GPBObjCClassDeclaration(DFSessionEntityType);
GPBObjCClassDeclaration(DFStreamingRecognitionResult);
GPBObjCClassDeclaration(DFTextInput);
GPBObjCClassDeclaration(GPBStruct);
GPBObjCClassDeclaration(GTPLatLng);
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "queryParams",
        .dataTypeSpecific.clazz = GPBObjCClass(DFQueryParameters),
      ...
      {
        .name = "queryInput",
        .dataTypeSpecific.clazz = GPBObjCClass(DFQueryInput),
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFOutputAudioConfig),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "geoLocation",
        .dataTypeSpecific.clazz = GPBObjCClass(GTPLatLng),
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFSessionEntityType),
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFSentimentAnalysisRequestConfig),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "audioConfig",
        .dataTypeSpecific.clazz = GPBObjCClass(DFInputAudioConfig),
      ...
      {
        .name = "text",
        .dataTypeSpecific.clazz = GPBObjCClass(DFTextInput),
...
void DFQueryInput_ClearInputOneOfCase(DFQueryInput *message) {
  GPBDescriptor *descriptor = [DFQueryInput descriptor];
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFSentimentAnalysisResult),
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFKnowledgeAnswers),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "answersArray",
        .dataTypeSpecific.clazz = GPBObjCClass(DFKnowledgeAnswers_Answer),
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[DFKnowledgeAnswers_Answer class]
                                   ...
                                   storageSize:sizeof(DFKnowledgeAnswers_Answer__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    [localDescriptor setupContainingMessageClass:GPBObjCClass(DFKnowledgeAnswers)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
    descriptor = localDescriptor;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFStreamingRecognitionResult),
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFSentiment),
