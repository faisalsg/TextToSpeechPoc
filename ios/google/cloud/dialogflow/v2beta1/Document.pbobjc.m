...
#import "google/cloud/dialogflow/v2beta1/Document.pbobjc.h"
...
GPBObjCClassDeclaration(DFDocument);
...
void DFDocument_ClearSourceOneOfCase(DFDocument *message) {
  GPBDescriptor *descriptor = [DFDocument descriptor];
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "documentsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(DFDocument),
