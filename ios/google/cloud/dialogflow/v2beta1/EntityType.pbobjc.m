...
GPBObjCClassDeclaration(DFEntityType);
GPBObjCClassDeclaration(DFEntityTypeBatch);
GPBObjCClassDeclaration(DFEntityType_Entity);
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "entitiesArray",
        .dataTypeSpecific.clazz = GPBObjCClass(DFEntityType_Entity),
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[DFEntityType_Entity class]
                                   ...
                                   storageSize:sizeof(DFEntityType_Entity__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    [localDescriptor setupContainingMessageClass:GPBObjCClass(DFEntityType)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
    descriptor = localDescriptor;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFEntityType),
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = GPBObjCClass(DFEntityTypeBatch),
...
void DFBatchUpdateEntityTypesRequest_ClearEntityTypeBatchOneOfCase(DFBatchUpdateEntityTypesRequest *message) {
  GPBDescriptor *descriptor = [DFBatchUpdateEntityTypesRequest descriptor];
