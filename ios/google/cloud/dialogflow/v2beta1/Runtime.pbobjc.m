...
#import "google/cloud/dialogflow/v2beta1/Runtime.pbobjc.h"
...
GPBObjCClassDeclaration(Runtime);
GPBObjCClassDeclaration(RuntimeHistory);
GPBObjCClassDeclaration(RuntimeHistory_Entry);
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "runtimesArray",
        .dataTypeSpecific.clazz = GPBObjCClass(Runtime),
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "entriesArray",
        .dataTypeSpecific.clazz = GPBObjCClass(RuntimeHistory_Entry),
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[RuntimeHistory_Entry class]
                                   ...
                                   storageSize:sizeof(RuntimeHistory_Entry__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    [localDescriptor setupContainingMessageClass:GPBObjCClass(RuntimeHistory)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
    descriptor = localDescriptor;
